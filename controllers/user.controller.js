const { signupService, findUserByEmail, findUserByToken, updateUserService, getUsersService } = require("../services/user.service");
...
exports.getAllUser = async (req, res, next) => {
  try {
    const users = await getUsersService(req.body);
...
exports.getAllUserByEmail = async (req, res, next) => {
  ...
  try {
    ...
    if (!result.nModified) {
      return res.status(400).json({
        status: "fail",
        error: "Couldn't update the user with this email",
      });
    }
